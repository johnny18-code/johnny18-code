...
- ⚙️ Knowledge in: `.py-desktop-gui`, `.py-web-streamlit`, `.html`, `.css`, `.javascript`, `.api-usage`
- 🌍 I'm mostly active within the **Mainframe Community**
- 💅 Batch Support, Online Support, User-facing issue resolution, Abend-Fix, Batch(job) enhancement and automation.
